...
def client():
    ...
    @sitemapper.include(url_variables={"person": ["john", "sarah"]})
    @contact.route("/email/<person>")
    def r_email(person):
        return f"<h1>Email {person}</h1>"
...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  ...
  <url>
    <loc>https://localhost/contact/email/john</loc>
  </url>
  <url>
    <loc>https://localhost/contact/email/sarah</loc>
  </url>
</urlset>"""
